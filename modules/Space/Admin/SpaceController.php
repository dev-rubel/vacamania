...
class SpaceController extends AdminController
{
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs'    => [
                [
                    'name' => __('Next Departure'),
                    'url'  => 'admin/module/space'
                ],
                [
                    'name'  => __('Add Next Departure'),
                    'class' => 'active'
                ],
            ],
            'page_title'     => __("Add new Next Departure")
        ];
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return redirect(route('space.admin.edit',$row->id))->with('success', __('Next Departure created') );
            }
        }
    }
