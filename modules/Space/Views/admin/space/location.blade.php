    ...
    <div class="panel-body">
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Tour Location")}}</label>
                <div class="">
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("another location")}}</label>
            <input type="text" name="address" class="form-control" placeholder="{{__("eg, singapore, thailand etc")}}" value="{{$translation->address}}">
        </div>
        @if(is_default_lang())
            <div class="form-group">
