<div class="panel">
    <div class="panel-title"><strong>{{__("Next Departure Content")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Title OF Service")}}</label>
            <input type="text" value="{{$translation->title}}" placeholder="{{__("Name of Service")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group-item">
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="faqs[__number__][title]" class="form-control" placeholder="{{__('Eg: Day 1 - departure  from KLIA')}}">
                        </div>
                        <div class="col-md-6">
        ...
        @if(is_default_lang())
<div class="panel">
    <div class="panel-title"><strong>{{__("Next Departure Info")}}</strong></div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label>{{__("No OF Adult has book")}}</label>
                    <input type="number" value="{{$row->bed}}" placeholder="{{__("Example: 3")}}" name="bed" class="form-control">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>{{__("No OF child has book")}}</label>
                    <input type="number" value="{{$row->bathroom}}" placeholder="{{__("Example: 5")}}" name="bathroom" class="form-control">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>{{__("Day OF Tour")}}</label>
                    <input type="number" value="{{$row->square}}" placeholder="{{__("Example: 1")}}" name="square" class="form-control">
                </div>
            </div>
        @if(is_default_lang())
            <div class="form-group">
