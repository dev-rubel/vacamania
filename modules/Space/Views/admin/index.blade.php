...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("All Next departure")}}</h1>
            <div class="title-actions">
                <a href="{{route('space.admin.create')}}" class="btn btn-primary">{{__("Add new Next departure")}}</a>
            </div>
        </div>
            ...
            <div class="panel-body">
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        @else
                            <tr>
                                <td colspan="7">{{__("No Next departure found")}}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
