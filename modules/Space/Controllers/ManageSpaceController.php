...
class ManageSpaceController extends FrontendController
{
    ...
    public function manageSpace(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Manage Next Departure"),
        ];
    ...
    public function createSpace(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Create Next Departure"),
        ];
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                return back()->with('success',  __('Next Departure updated') );
            }else{
                return redirect(route('space.vendor.edit',['id'=>$row->id]))->with('success', __('Next Departure created') );
            }
        }
    }
    ...
    public function editSpace(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('space.vendor.index'))->with('warning', __('Next Departure not found!'));
        }
        ...
        $data = [
            ...
            'page_title'         => __("Edit Next Departure"),
        ];
        return view('Space::frontend.manageSpace.detail', $data);
    }
    ...
    public function deleteSpace($id)
    {
        ...
        return redirect(route('space.vendor.index'))->with('success', __('Delete Next Departure success!'));
    }
	...
	public function cloneSpace(Request $request,$id){
		...
		try{
			...
			return redirect()->back()->with('success',__('Next Departure clone was successful'));
