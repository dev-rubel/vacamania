...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Vacamania'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Vacamania')}} <a href="{{__('https://vacamania.com/')}}" target="_blank">{{__('Get your travel on !')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://vacamania.com/page/about-us')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://vacamania.com/contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
