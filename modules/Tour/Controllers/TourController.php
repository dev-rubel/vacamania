<?php
    ...
    class TourController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if(is_null($request->tour_id)) {
                $model_Tour = $this->tourClass::select("bravo_tours.*");
                $model_Tour->where('bravo_tours.title', 'like', '%' . $request->search_value . '%');
                $model_Tour->where("bravo_tours.status", "publish");
            } else {
                $model_Tour = $this->tourClass::select("bravo_tours.*")->where('bravo_tours.id', $request->tour_id);
                $model_Tour->where("bravo_tours.status", "publish");
            }
