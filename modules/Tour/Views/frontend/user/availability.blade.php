...
@section ('content')
    ...
    <div class="language-navigation">
        <div class="panel-body">
            <div class="filter-div d-flex justify-content-between ">
                ...
                <div class="col-right">
                    @if($rows->total() > 0)
                        <span class="count-string">{{ __("Showing :from - :to of :total service",["from"=>$rows->firstItem(),"to"=>$rows->lastItem(),"total"=>$rows->total()]) }}</span>
                    @endif
                </div>
            </div>
        </div>
    ...
    @else
        <div class="alert alert-warning">{{__("No service found")}}</div>
    @endif
        ...
        formModal = new Vue({
            ...
            created:function () {
                ...
                this.$nextTick(function () {
                    $('.has-daterangepicker').daterangepicker({ "locale": {"format": "DD/MM/YYYY"}})
