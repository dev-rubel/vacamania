<div class="panel">
    <div class="panel-title"><strong>{{__("Service Locations")}}</strong></div>
    <div class="panel-body">
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("Another adddress")}}</label>
            <input type="text" name="address" class="form-control" placeholder="{{__("eg, kuala lumpur and penang")}}" value="{{$translation->address}}">
        </div>
        @if(is_default_lang())
            <div class="form-group">
