<div class="panel">
    <div class="panel-title"><strong>{{__("Service Content")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Title")}}</label>
            <input type="text" value="{{$translation->title}}" placeholder="{{__("Service title")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
